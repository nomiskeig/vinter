...
/lib/ld-linux-x86-64.so.2 --library-path /lib /bin/mount_dynamic -tNOVA -oinit /dev/pmem2 /mnt
/lib/ld-linux-x86-64.so.2 --library-path /lib /bin/sync
...
/lib/ld-linux-x86-64.so.2 --library-path /lib /bin/echo HelloWorld > /mnt/myfile
